...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIdToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar outro usuario exceto o seu."))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIdToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel deletar outro usuario exceto o seu."))
		return
	}
...
func DeixarSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioUsuarios(db)
	if erro = repositorio.DeixarSeguirUsuario(usuarioID, seguidorID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIdToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Recurso não pode ser acessado."))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha atual é inválida."))
		return
	}
